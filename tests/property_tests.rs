...
// ===========================================================================
// Parallel entry-point tests (feature = "parallel")
// ===========================================================================
...
mod parallel_tests {
    ...
    proptest! {
        /// Parallel and sequential check_operations must agree on register histories.
        /// INV-LIN-01 + INV-LIN-02.
        #[test]
    ...
    /// Parallel checker must detect the known illegal register history. INV-LIN-02.
    #[test]
    ...
    proptest! {
        /// Parallel and sequential check_events must agree on register event histories.
        /// INV-LIN-01 + INV-LIN-02.
        #[test]
    ...
    proptest! {
        /// For a partitioned KV history, parallel and sequential must agree.
        /// Exercises actual partition-level parallelism. INV-LIN-03.
        #[test]
        fn prop_parallel_kv_agrees_with_sequential(
            n_ops in 2usize..10,
            keys  in prop::collection::vec(0u8..4, 2..10),
            vals  in prop::collection::vec(0i64..10, 2..10),
        ) {
            let history: Vec<Operation<KvInput, i64>> = (0..n_ops)
                .map(|i| Operation {
                    client_id: i as u64,
